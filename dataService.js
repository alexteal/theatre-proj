...
import { remove, getDatabase, ref, set, onValue, get, update, push } from "firebase/database";
...
export function updateMovieData(movieId, title, trailerUrl, thumbnail, runningStatus) {
    return new Promise((resolve, reject) => {
        try {
            const db = getDatabase(app);
